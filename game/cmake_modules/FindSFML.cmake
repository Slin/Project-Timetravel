...
if(SFML_STATIC_LIBRARIES)
    ...
    if(NOT ${FIND_SFML_WINDOW_COMPONENT} EQUAL -1)
        ...
        elseif(FIND_SFML_OS_MACOSX)
            if(IOS)
                set(SFML_WINDOW_DEPENDENCIES ${SFML_WINDOW_DEPENDENCIES} "-framework OpenGLES -framework Foundation -framework UIKit -framework QuartzCore -framework CoreMotion")
            else()
    ...
    if(NOT ${FIND_SFML_AUDIO_COMPONENT} EQUAL -1)
        ...
        # update the list
        set(SFML_AUDIO_DEPENDENCIES "-lz -lbz2" ${OPENAL_LIBRARY} ${FLAC_LIBRARY} ${VORBISENC_LIBRARY} ${VORBISFILE_LIBRARY} ${VORBIS_LIBRARY} ${OGG_LIBRARY})
